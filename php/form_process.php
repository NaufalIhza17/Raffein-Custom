...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST['action']) and $_POST['action'] == 'subscribe' ) {
        $email = $_POST["email"];
        $telephone = "Telephone Subscribe Email"; // Replace your Subject Here
        ...
        if (mail($to, $telephone, $messageBody, $headers)) {
        ...
        $telephone = $_POST['telephone']; // Replace your Subject Here
